...
export default function PantonePaper({colors, topLeft, bottomRight}:paperprops){
    return(
        <div className={`border-2 border-black border-solid grow flex items-center`} style={{background: `linear-gradient(to right bottom,${topLeft} , ${bottomRight})`}} id="pantone-paper">
